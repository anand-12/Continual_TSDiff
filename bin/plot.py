...
def create_continual_learning_plots(start_series: int = 0, num_series: int = 1):
    ...
    checkpoints = {
        ...
        "L1 Reg": "/Users/anand/Desktop/SBU/Continual_TSDiff/full_experiments_3/order_1_kdd_cup_pedestrian_counts_uber_tlc/method_score_l1/lambda_reg_0.5/task_1_kdd_cup_2018_without_missing/kdd_cup_2018_without_missing_checkpoint_best.pth",
        ...
        # "Single Task": "/Users/anand/Desktop/SBU/Continual_TSDiff/01_kdd_cup/results.yaml"
    }
    # checkpoints = {
    #     "Naive": "/export/home/anandr/diffusion/Continual_TSDiff/full_experiments_3/order_1_kdd_cup_pedestrian_counts_uber_tlc/method_naive/task_3_uber_tlc_hourly/uber_tlc_hourly_checkpoint_best.pth",
    ...
    config = yaml.safe_load(open("/Users/anand/Desktop/SBU/Continual_TSDiff/configs/eval_continual.yaml"))
...
def main():
    ...
    create_continual_learning_plots(start_series=23, num_series=10)  # First 3 time series
